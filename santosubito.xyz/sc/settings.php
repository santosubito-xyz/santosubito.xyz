...
define('TINYIB_ADMINPASS', 'antonio1276');       // Administrators have full access to the board
...
define('TINYIB_BOARDDESC', 'SantoChan'); // Displayed at the top of every page
...
define('TINYIB_TRIPSEED', 'jansuzpsadfpsdfasdadfasadfa');        // Enter some random text  (used when generating secure tripcodes)
